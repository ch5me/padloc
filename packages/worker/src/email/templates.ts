...
export const templateNames = ["confirm-org-member-invite", "email-auth", "failed-login-attempt", "join-org-invite", "join-org-invite-accepted", "join-org-invite-completed", "new-login", "plain"] as const;
