                                        ...
                                        <tr>
                                            <td style="font-family: sans-serif; font-size: 14px; vertical-align: top">
                                                ...
                                                >
                                                    ...
                                                    with the Elf Vault organization <strong>{{ orgName }}</strong>.
                                                </p>
                                ...
                                <tr>
                                    ...
                                    >
                                        <span
                                            ...
                                            >This email was sent to you by Elf Vault. If you have
                                            any questions, please don't hesitate to contact us at support@ch5.me!</span
                                        >
...
You have been asked by {{ invitedBy }} to confirm your membership with the Elf Vault organization {{ orgName }}.

Confirm Membership: {{ acceptInviteUrl }}

Have a great day!

This email was sent to you by Elf Vault. If you have any questions, please don't hesitate to contact us at support@ch5.me!`,
                                        ...
                                        <tr>
                                            <td style="font-family: sans-serif; font-size: 14px; vertical-align: top">
                                                ...
                                                >
                                                    ...
                                                    <strong>failed</strong> attempt to login to your account in CH5
                                                    Auth, from {{ location }}.
                                                </p>
...
This is just an email to warn you that there was a failed attempt to login to your account in Elf Vault, from {{ location }}.
                                        ...
                                        <tr>
                                            <td style="font-family: sans-serif; font-size: 14px; vertical-align: top">
                                                ...
                                                >
                                                    ...
                                                    their Elf Vault organization <strong>{{ orgName }}</strong>!
                                                </p>
...
You have been invited by {{ invitedBy }} to join their Elf Vault organization {{ orgName }}!
                                        ...
                                        <tr>
                                            <td style="font-family: sans-serif; font-size: 14px; vertical-align: top">
                                                ...
                                                <p
                                                    ...
                                                    "
                                                >
                                                    Good news! You now have access to the Elf Vault organization
...
Good news! You now have access to the Elf Vault organization {{ orgName }}.

Open Elf Vault: {{ openAppUrl }}
                                    ...
                                    >
                                        <tr>
                                            <td style="font-family: sans-serif; font-size: 14px; vertical-align: top">
                                                ...
                                                >
                                                    This is just an email to warn you that there was a
                                                    <strong>new successful login</strong> to your account in Elf Vault,
                                                    from {{ location }}.
                                                </p>
...
This is just an email to warn you that there was a new successful login to your account in Elf Vault, from {{ location }}.
