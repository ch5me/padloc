...
import { PublicKeyAuthClient } from "@elf-vault/core/src/auth/public-key";
import { StartRegisterAuthenticatorResponse, StartAuthRequestResponse } from "@elf-vault/core/src/api";
